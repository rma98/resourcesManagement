    ...
    methods: {
        ...
        async handleForgotPassword() {
            ...
            try {
                ...
                this.successMessage = "Se o email informado estiver cadastrado, você receberá um link para redefinir sua senha.";
                this.email = ""; // Limpa o campo de email após o sucesso
                // Define um timeout para limpar a mensagem de sucesso após 5 segundos
                setTimeout(() => {
                    this.successMessage = "";
                }, 5000);
            } catch (error) {
