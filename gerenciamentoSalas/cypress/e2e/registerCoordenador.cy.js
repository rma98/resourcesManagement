describe("Cadastro de Coordenador", () => {
    beforeEach(() => {
        ...
        // Clica no link para a página de cadastro de coordenador
        cy.get("a[href='/register-coordenador']").click();
    });

    it("Deve preencher o formulário e cadastrar um coordenador com sucesso", () => {
        cy.get("input[placeholder='Digite seu nome completo']").type("Delano Oliveira");
        cy.get("input[placeholder='Digite seu email']").type("delano.oliveira@example.com");
    ...
    it("Deve impedir cadastro caso o nome tenha menos de duas palavras", () => {
        cy.get("input[placeholder='Digite seu nome completo']").type("Delano");
        cy.get("input[placeholder='Digite seu email']").type("delano.oliveira@example.com");
        cy.get("input[placeholder='Digite sua senha']").type("SenhaForte@123");
    ...
    it("Deve exibir erro ao tentar cadastrar com um email já cadastrado", () => {
        cy.get("input[placeholder='Digite seu nome completo']").type("Delano Oliveira");
        cy.get("input[placeholder='Digite seu email']").type("delano.oliveira@example.com"); // Email já existente
        cy.get("input[placeholder='Digite sua senha']").type("SenhaForte@123");
    ...
    it("Deve exibir erro ao tentar cadastrar com um nome muito longo", () => {
        cy.get("input[placeholder='Digite seu nome completo']").type("Delano".repeat(20));
        cy.get("input[placeholder='Digite seu email']").type("delano.oliveira@example.com");
        cy.get("input[placeholder='Digite sua senha']").type("SenhaForte@123");
